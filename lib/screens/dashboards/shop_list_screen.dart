...
class _ShopListScreenState extends State<ShopListScreen> {
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: loading ? null : () async {
                    ...
                    try {
                      final res = await ApiService.put('${ApiConfig.baseUrl}/shops/${shop['_id']}', {
                      ...
                      if (res.statusCode == 200) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Failed to rename')));
                      }
                    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Manage Shops', style: TextStyle(fontWeight: FontWeight.bold)),
      ...
      body: _isLoading 
        ...
        : ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final String uniqueId = 'S-${shopIdStr.substring(shopIdStr.length - 6).toUpperCase()}';
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  title: Text(shop['name'], style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  ...
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(
                      builder: (_) => ShopUsersScreen(shopId: shop['_id'], shopName: shop['name']),
                    ));
                  },
                ),
              );
